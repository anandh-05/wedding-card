export default function WhatsAppShare({ shareText }) {
  ...
  return (
    <button
      type="button"
      onClick={handleShare}
      className="fixed bottom-5 left-5 z-40 inline-flex items-center gap-3 rounded-full border border-[#46c464]/40 bg-[#103d1f]/80 px-4 py-3 text-sm font-medium text-[#f2fff5] shadow-[0_18px_40px_rgba(0,0,0,0.3)] backdrop-blur-md transition hover:-translate-y-0.5 hover:bg-[#165028] sm:bottom-8 sm:left-8"
